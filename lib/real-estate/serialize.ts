...
export function serializeReProperty(property: RePropertyDetail) {
  return {
    ...
    soldDate: dateIso(property.soldDate),
    soldPriceOmr: dec(property.soldPriceOmr),
    ...
    exit: property.asset?.exit
      ? {
          id: property.asset.exit.id,
          exitType: property.asset.exit.exitType,
          exitDate: dateIso(property.asset.exit.exitDate)!,
          proceeds: dec(property.asset.exit.proceeds),
          currency: property.asset.exit.currency,
          counterparty: property.asset.exit.counterparty,
          acquisitionCost: dec(property.asset.exit.acquisitionCost),
          realizedGain: dec(property.asset.exit.realizedGain),
          realizedGainPct: dec(property.asset.exit.realizedGainPct),
          recordCashInflow: property.asset.exit.recordCashInflow,
          notes: property.asset.exit.notes,
          landSaleId: property.asset.exit.landSaleId,
          documents: property.asset.exit.documents.map((d) => ({
            id: d.id,

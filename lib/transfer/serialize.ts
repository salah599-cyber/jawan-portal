...
export function transferLetterToFormData(letter: TransferLetter): TransferLetterFormData {
  return {
    ...
    beneficiaryRoutingNumber: letter.beneficiaryRoutingNumber ?? "",
    correspondentBankName: letter.correspondentBankName ?? "",
    correspondentSwiftCode: letter.correspondentSwiftCode ?? "",
    correspondentRoutingNumber: letter.correspondentRoutingNumber ?? "",
    correspondentFfcInstructions: letter.correspondentFfcInstructions ?? "",

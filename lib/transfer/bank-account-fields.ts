...
export function bankAccountPickToBeneficiaryFields(option: TransferLetterAccountPickOption) {
  return {
    ...
    beneficiaryRoutingNumber: option.routingNumber ?? "",
    correspondentBankName: option.correspondentBankName ?? "",
    correspondentSwiftCode: option.correspondentSwiftCode ?? "",
    correspondentRoutingNumber: option.correspondentRoutingNumber ?? "",
    correspondentFfcInstructions: option.correspondentFfcInstructions ?? "",
  };
}

...
CREATE TYPE "RePropertyType" AS ENUM ('VILLA', 'APARTMENT_BUILDING', 'COMMERCIAL_BUILDING', 'MIXED_USE', 'LAND', 'WAREHOUSE', 'APARTMENT', 'OFFICE', 'SHOP', 'SHOWROOM', 'STUDIO', 'PENTHOUSE', 'OTHER');
